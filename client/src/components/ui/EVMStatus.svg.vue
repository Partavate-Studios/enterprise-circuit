	...
	<g>
		<g :transform="'translate(0 ' + (screen.top + 30) + ')'">
			...
			<g v-if="evm.isConnected">
				...
				<g font-size="12px">
					<g fill="#999999">
						...
						<g text-anchor="start">
							<text v-if="world.isLoading" transform="translate(10 -8)"> Loading </text>
							<text v-else-if="world.isLoaded" transform="translate(10 -8)"> Loaded </text>
			...
			<g v-else>
				<g font-size="12px">
					<g fill="#999999">
						<text transform="translate(0 0)"> network offline </text>
					</g>
				</g>
			</g>
			<rect
