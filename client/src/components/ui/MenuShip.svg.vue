...
<template>
	...
	<g v-if="panel == 0">
		<text transform="translate(-250 -240)" font-size="28px" text-anchor="start"
			>Registered Owner: {{ world.avatar.me.name }}
		</text>

		<text transform="translate(-130 180)" font-size="38" text-anchor="start">Please name your Orbiter 8: </text>
	...
	<g v-if="panel == 1 || panel == 2">
		<g font-size="32px" transform="translate(-200 280)" text-anchor="middle">
			<rect
				...
				stroke-opacity="0.25"
			/>
			<btn font-size="32" :width="200" :height="60" text="Retry" @click="panel = 0" />
		</g>
	</g>
