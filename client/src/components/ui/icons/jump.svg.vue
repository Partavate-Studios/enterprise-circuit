...
import icon from './_icon.svg.vue'
...
<template>
	<icon>
		<g transform="scale(0.1)">
			...
			<g v-for="(neighbor, index) in galaxy.chainstate.systemData.neighbors" v-bind:key="index">
				<g :transform="'rotate(' + index * 30 + ')'" v-if="BigInt(neighbor) > 0">
