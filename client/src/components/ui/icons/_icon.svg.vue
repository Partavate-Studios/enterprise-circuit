	...
	<g @mouseover="hover = true" @mouseleave="hover = false">
		<defs>
			<clipPath id="icon-clip">
				<circle cx="0" cy="0" r="36" stroke-width="1" />
			</clipPath>
		</defs>

		<g clip-path="url(#icon-clip)">
			<circle cx="0" cy="0" r="36" stroke="#ffffff22" stroke-width="1" :fill="fillColor" />
			<g :transform="'scale(' + scaleSize + ')'" :opacity="disabled ? 0.25 : 1">
				<slot />
			</g>
		</g>
		<circle class="canclick" cx="0" cy="0" r="46" stroke-width="0" fill-opacity="0" fill="#000000" />
