...
<template>
	<g>
		<MinervaFrame />
		<text transform="translate(-250 -350)" text-anchor="start" fill="#aaaaaa" font-size="48"
			>Callsign Registration</text
		>
	</g>
	<g v-if="panel == 0">
	...
	<g v-if="panel == 1">
		<g transform="translate(0 20)">
			...
			<g fill="#888888" fill-opacity="0.5" transform="translate(-160 -220)">
				<text transform="translate(0 80)" font-size="24" text-anchor="start">Pilot Identification</text>
				<text
					v-if="avatarName.length < 1"
				...
				<text
					...
					>{{ avatarName }}</text
				>
				<text transform="translate(400 180)" font-size="20" text-anchor="start">Rank: Newb</text>
		...
		<text transform="translate(-130 180)" font-size="38" text-anchor="start">Please enter your callsign: </text>
	...
	<g v-if="panel == 2 || panel == 3">
		<g font-size="32px" transform="translate(-200 280)" text-anchor="middle">
			<rect
				...
				stroke-opacity="0.25"
			/>
			<btn font-size="32" :width="200" :height="60" text="Retry" @click="panel = 1" />
		</g>
	</g>
	...
	<g font-size="42px" :transform="'translate(0 ' + (screen.bottom - 20) + ')'">
		<g :transform="'scale(' + ui.UIScale + ')'">
			<btn :width="200" :height="60" text="Title" @click="ui.changeMenu('title')" transform="translate(0 -80)" />
		</g>
	</g>
</template>
