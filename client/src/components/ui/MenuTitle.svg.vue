		...
		<g :transform="'scale(' + ui.UIScale + ')'">
			<g font-size="48px" transform="translate(0 20)">
				<g v-if="!world.isConnected">
					<btn :width="520" :height="100" text="Connect" @click="ui.changeMenu('connect')" />
				</g>
				<g v-else-if="!world.avatar.playerHasAvatar">
					<btn fill="#ffffff" :width="520" :height="100" text="Begin" @click="routing.switch('play')" />
				</g>
				<g v-else-if="!world.galaxy.haveShip">
					<btn fill="#ffffff" :width="520" :height="100" text="Launch" @click="routing.switch('play')" />
				</g>
				<g v-else>
					<btn fill="#ffffff" :width="520" :height="100" text="Continue" @click="routing.switch('play')" />
				</g>
			</g>
