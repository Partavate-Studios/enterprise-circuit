...
export default {
	...
	mounted() {
		window.addEventListener('keydown', this.keyHandler), window.addEventListener('mousedown', this.mousedownHandler)
...
<template>
	...
	<text font-size="28px" text-anchor="start" font-family="monospace" transform="translate(-250 0)" fill="#ffffff">{{
		displayText
	}}</text>

	<rect x="-280" y="-25" width="500" height="50" fill-opacity="0" class="canclick" @click="editing = true" />
