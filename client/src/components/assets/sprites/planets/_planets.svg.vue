...
<template>
	<g>
		<g>
			<g
				:transform="'translate(' + -100 * hMult + ' ' + -100 * vMult + ') scale(' + pScale * 3 + ')'"
				class="smooth"
			>
				<star />
			</g>
			...
			<g :transform="'translate(' + -19 * hMult + ' ' + -19 * vMult + ') scale(' + pScale + ')'" class="smooth">
				<mercury :showMoons="showSats" :showStation="showSats" :rotationPeriod="rotational" />
			</g>
			<g :transform="'translate(' + -10 * hMult + ' ' + -10 * vMult + ') scale(' + pScale + ')'" class="smooth">
				<venus :showMoons="showSats" :showStation="showSats" :rotationPeriod="rotational" />
			</g>
			<g :transform="'translate(' + 0 * hMult + ' ' + 0 * vMult + ') scale(' + pScale + ')'" class="smooth">
				<earth :showMoons="showSats" :showStation="showSats" :rotationPeriod="rotational" />
			</g>
			<g :transform="'translate(' + 10 * hMult + ' ' + 10 * vMult + ') scale(' + pScale + ')'" class="smooth">
				<mars :showMoons="showSats" :showStation="showSats" :rotationPeriod="rotational" />
			</g>
			<g :transform="'translate(' + 30 * hMult + ' ' + 30 * vMult + ') scale(' + pScale + ')'">
				<jupiter :showMoons="showSats" :showStation="showSats" :rotationPeriod="rotational" />
			</g>
			<g :transform="'translate(' + 55 * hMult + ' ' + 55 * vMult + ') scale(' + pScale + ')'" class="smooth">
				<saturn :showMoons="showSats" :showStation="showSats" :rotationPeriod="rotational" />
			</g>
			<g :transform="'translate(' + 80 * hMult + ' ' + 80 * vMult + ') scale(' + pScale + ')'" class="smooth">
				<uranus :showMoons="showSats" :showStation="showSats" :rotationPeriod="rotational" />
			</g>
			<g :transform="'translate(' + 100 * hMult + ' ' + 100 * vMult + ') scale(' + pScale + ')'" class="smooth">
				<neptune :showMoons="showSats" :showStation="showSats" :rotationPeriod="rotational" />
			</g>
			<g :transform="'translate(' + 120 * hMult + ' ' + 120 * vMult + ') scale(' + pScale + ')'" class="smooth">
				<pluto :showMoons="showSats" :showStation="showSats" :rotationPeriod="rotational" />
			</g>
		</g>
	</g>
</template>
