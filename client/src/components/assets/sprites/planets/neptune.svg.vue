...
<template>
	<g>
		<g>
			<planet :classification="4" :size="19.5" :rotationPeriod="rotationPeriod" :rings="4" />
		</g>
		<g v-if="showMoons">
			<orbit :duration="25" :distance="90">
				<moon :size="1" />
			</orbit>
			<orbit :duration="22" :distance="-100">
				<moon :size="9" />
			</orbit>
			<orbit :duration="28" :distance="110">
				<moon :size="1" />
			</orbit>
		</g>
		<g v-if="showStation">
