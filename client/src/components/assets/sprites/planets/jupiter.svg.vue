...
<template>
	<g>
		<g>
			<planet :classification="6" :size="55" :rotationPeriod="rotationPeriod" />
		</g>
		<g v-if="showMoons">
			<orbit :duration="40" :distance="100">
				<moon :size="10" />
			</orbit>
			<orbit :duration="50" :distance="-110">
				<moon :size="8" />
			</orbit>
			<orbit :duration="45" :distance="120">
				<moon :size="14" />
			</orbit>
			<orbit :duration="70" :distance="-130">
				<moon :size="14" />
			</orbit>
		</g>
		<g v-if="showStation">
			<orbit :duration="110" :distance="60">
				<station :size="12" />
