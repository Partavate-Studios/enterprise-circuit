...
<template>
	<g>
		<g :transform="'scale(' + (size / 16 + 0.5) + ')'">
			...
			<g>
				<circle cx="0" cy="0" r="10" :stroke="planetStroke" stroke-width="0.25" :fill="planetFill" />
			</g>
			...
			<g clip-path="url(#just-the-planet)">
				...
				<g v-if="classification == 2"> </g>
				<g v-if="classification == 3"> </g>
