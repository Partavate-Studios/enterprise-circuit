...
<template>
	...
	<g transform="translate(0 0)">
		...
		<btn :width="70" :height="50" text="+" @click="ui.setUIScale(ui.UIScale + 0.25)" transform="translate(280 0)" />
		<btn :width="70" :height="50" text="&times;" @click="ui.setUIScale(1)" transform="translate(200 0)" />
		<btn :width="70" :height="50" text="-" @click="ui.setUIScale(ui.UIScale - 0.25)" transform="translate(120 0)" />
	</g>
	...
	<g font-size="42px" :transform="'translate(0 ' + (screen.bottom - 20) + ')'">
		<g :transform="'scale(' + ui.UIScale + ')'">
			<btn :width="200" :height="60" text="Title" @click="routing.switch('title')" transform="translate(0 -80)" />
		</g>
	</g>
</template>
