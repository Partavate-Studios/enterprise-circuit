<template>
	<g>
		<defs>
			...
			<linearGradient id="engineGradient" gradientTransform="rotate(90)" x1="0%" y1="0%" x2="100%" y2="0">
			...
			<linearGradient id="ringGradient" x1="100%" y1="100%" x2="-100%" y2="-100%" gradientTransform="rotate(135)">
			...
			<filter id="glowing">
				<feGaussianBlur in="source" stdDeviation="5" result="blur" />
				<feMerge>
