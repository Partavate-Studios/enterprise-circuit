...
<template>
	...
	<linearGradient id="floorGradient" x1="50%" y1="0%" x2="50%" y2="100%">
		<stop offset="0%" stop-color="#000000" stop-opacity="0.1" />
		<stop offset="100%" stop-color="#000000" stop-opacity="0.75" />
	</linearGradient>
	<rect :x="screen.left" :y="screen.bottom - 300" :width="screen.width" :height="300" fill="url(#floorGradient)" />

	<linearGradient id="cielingGradient" x1="50%" y1="0%" x2="50%" y2="100%">
	...
	<g fill="#140626" stroke="#d4c4eb" stroke-width="1">
		...
		<g
			...
			stroke-opacity="0.5"
			fill-opacity="0"
			:transform="'translate(' + (screen.left + 100) + ' ' + (screen.top + 400) + ')'"
		>
			<moon :size="50" />
		</g>
		<g
