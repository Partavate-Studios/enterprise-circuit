...
<template>
	<g>
		<g :transform="'translate(0 ' + (screen.bottom - 50) + ')'" v-if="!screen.isAutoPresent">
			...
			/>
			<g font-size="10px">
				<g fill-opacity="0.5" :transform="'translate(' + (panelCount + 3) * -35 + ' 0)'">
					<btn
						v-if="panel > 0"
						fill="#ffff88"
						:width="20"
				...
				<g fill-opacity="0.75" fill="#ffff88" :transform="'translate(' + (panelCount + 3) * 35 + ' 0)'">
					<btn
						:width="50"
						:height="20"
						@click="next"
						...
						transform="scale(3)"
					/>
					<btn :width="60" :height="20" @click="finish" text="Try It" v-else transform="scale(2)" />
				</g>
			</g>
